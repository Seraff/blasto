...
infile = SeqIO.parse('/home/serafim/bio/blasto/data/DNA_scaffolds.fa', 'fasta')
output = open('/home/serafim/bio/blasto/data/DNA_scaffolds_translated.fa', 'w')
...
for sequence in infile:
    ...
    for nucleotide in seq:
        if nucleotide not in 'ATCGN':
            ambiguous = True
    if ambiguous == True:
        with open('tmp/error.fasta', 'w') as error:
            error.write('{}\n{}\n'.format(name, seq))
    else:
